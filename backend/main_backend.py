...
allowed_origins = os.getenv(
    "ALLOWED_ORIGINS",
    "https://ai-cv-analyser-dcxs.vercel.app,https://ai-cv-analyser-dcxs.vercel.app/,https://ai-cv-analyser-wxjq.onrender.com,http://localhost:5173,http://127.0.0.1:5173,http://[::1]:5173,http://localhost:8000",
).split(",")
